  ...
  <div class="col-xxl">
    <div class="card mb-4">
      <div class="card-header d-flex align-items-center justify-content-between">
        <h5 class="mb-0">Edit Slider</h5> <small class="text-muted float-end"></small>
      </div>
      ...
      @endif
        ...
        <input type="hidden" name="id" value="{{$slider->id}}">
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control" id="basic-default-company" name="cta_url" value="{{$slider->cta_url}}"/>
            </div>
          </div>
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-10">
              <input type="date" class="form-control" id="basic-default-company" name="start_date" value="{{ \Carbon\Carbon::parse($slider->start_date)->format('Y-m-d') }}"/>
            </div>
          </div>
          <div class="row mb-3">
            <label class="col-sm-2 col-form-label" for="basic-default-company">End Date</label>
            <div class="col-sm-10">
              <input type="date" class="form-control" id="basic-default-company" name="end_date" value="{{ \Carbon\Carbon::parse($slider->end_date)->format('Y-m-d') }}"/>
            </div>
          </div>
          <div class="row mb-3">
            <label class="col-sm-2 col-form-label" for="basic-default-company">Enabled</label>
            <div class="col-sm-10">
              <input type="radio" class="" name="enabled" value="true" @if($slider->enabled == true) checked @endif/> enabled
              <input type="radio" class="" name="enabled" value="false" @if($slider->enabled == false) checked @endif/> disabled
            </div>
          </div>
          ...
          <div class="row mb-3">
            ...
            <img src="{{$slider->filename}}" class="mt-3"/>
            </div>
          </div>-->
