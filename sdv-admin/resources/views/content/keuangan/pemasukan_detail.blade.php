...
@section('title', 'Laporan Pemasukan - Detail')
    ...
    <div class="mb-3 card-header">
        ...
        <div class="row gy-3">
            <div class="col-md">
                ...
                <div class="mb-3">
                    <label class="form-labels">Nama Pemasukan</label>
                    <p style="color:#000000; margin-top:0px;">{{$data->title}}</p>
                    
                </div>
                
                <div class="mb-3">
                    <label class="form-labels">Bukti Pemasukan</label> <br>
            ...
            <div class="col-md">
                ...
                <div class="mb-3">
                    <label class="form-labels">Periode Pemasukan</label>
