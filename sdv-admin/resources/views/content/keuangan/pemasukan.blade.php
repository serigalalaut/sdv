        ...
        <div class="col-lg-12 col-md-6 col-sm-12">
          <div class="card drag-item cursor-move mb-lg-0 mb-6">
            <div class="card-body text-center">
              ...
              <h4>Total Pemasukan Periode {{ date('F Y')}}</h4>
...
<a href="/laporan-pemasukan/add" class="btn btn-primary" style="margin-bottom: 10px;">Tambah Data Pemasukan</a>
<div class="card">
<div class="mb-3 card-header">
<h3 class="fw-bold py-3 mb-4">Data Pemasukan Periode {{ date('F Y')}}</h3> 
...
<a href="/laporan-pemasukan?period=" class="btn btn-primary" onclick="this.href='/laporan-pemasukan?period=' + document.getElementById('locfilter').value">Cari Periode Sebelumnya</a>
@if (session('success'))
      ...
      @foreach($pemasukan as $data)
        <tr>
          ...
          <td>
              ...
              <a href="/laporan-pemasukan/details/{{$data->id}}" class="btn btn-primary">Lebih Detail</a>
