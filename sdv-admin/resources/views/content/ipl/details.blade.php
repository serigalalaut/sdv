        ...
        <div class="row gy-3">
            ...
            <div class="col-md">
                ...
                <div class="mb-3">
                    ...
                    <a href="https://wa.me/{{$data->no_suami}}?text=Pembayaran IPL telah dikonfirmasi. Untuk melihat status cek https://wargasdv.com/rekap-ipl. Abaikan pesan ini, pesan dikirim oleh sistem." class="btn btn-outline-primary">{{$data->no_suami}}</a>
                </div>
                <div class="mb-3">
                    <label class="form-labels">Wa Istri</label> <br>
                    <a href="https://wa.me/{{$data->no_istri}}?text=Pembayaran IPL telah dikonfirmasi. Untuk melihat status cek https://wargasdv.com/rekap-ipl. Abaikan pesan ini, pesan dikirim oleh sistem." class="btn btn-outline-primary">{{$data->no_istri}}</a>
                </div>
                <div class="mb-3">
